...
const pcComponents = [
    { icon: VGA_icon, title: "VGA", description: "ASUS ROG Astral GeForce RTX 5080" },
    { icon: CPU_icon, title: "CPU", description: "Intel Core i9 12th Gen" },
    { icon: motherBoard_icon, title: "Motherboard", description: "ASUS ROG Maximus Z990" },
    { icon: RAM_icon, title: "RAM", description: "Corsair Vengeance RGB Pro 32GB" },
        ...
        <div className='homepage-card-div'>
            ...
            <div className='d-flex justify-content-center'>
                <div className='homePage-card mt-4' style={{ position: "relative" }}>
                    <img className='Card-graph-icon' width={20} src={card_graph_icon} alt="" />
                    <img style={{ cursor: "pointer" }} width={280} src={home_card_img} alt="" />
                    <div className='home-card-text'>
                        <div className='d-flex justify-content-center mt-3'>
                            <div className='d-flex justify-content-center homecard-whiteCircle'> </div>
                        </div>
                        <p>White</p>
                        <h3 style={{ fontWeight: 700 }}>CYBER</h3>
                        <p style={{ width: "280px" }}>Ready for the future. Aggressive futuristic design, made for true cyber warriors.</p>
                        <h5 style={{ fontWeight: 600 }}>from AED 24,520 </h5>
                        <p>or from AED 912 per month</p>
                    </div>
                    <div className='d-flex justify-content-center'><button className='configurate-button'>Configurate and buy</button></div>
                    <div className='d-flex justify-content-center mt-3'><button className='detaiils-button'>Details</button></div>
                    ...
                    <div className='d-flex justify-content-center flex-column mt-3'>
                        ...
                        {pcComponents.map((component, index) => (
                            <div key={index} className='d-flex align-items-center gap-3 homeCard-items-div mt-2'>
                        ...
                        <div style={{ position: "relative" }}>
                            ...
                            <button className='homeCard-add-button'><MdAdd />
                            </button>
                        </div>
                        <div className='d-flex justify-content-center'>
